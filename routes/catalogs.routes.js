...
const { getStates, getOcuppations, getEventParticipationModes, getPaymentMethods, getPaymentStatus, getUserDashboard, getUserInfo, getSummaryStatuses, getUsers } = require('../controllers/catalogs.controller');
const router = Router()
