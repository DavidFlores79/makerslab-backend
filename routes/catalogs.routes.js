...
const { getStates, getOcuppations, getEventParticipationModes, getPaymentMethods, getPaymentStatus, getUserDashboard, getUserInfo, getSummaryStatuses, getUsers, getRoles } = require('../controllers/catalogs.controller');
const router = Router()
