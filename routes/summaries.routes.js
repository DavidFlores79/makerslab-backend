...
const { getData, postData, updateData, deleteData, exportToExcel } = require('../controllers/summary.controller');
const { validateSummaryById } = require('../helpers/db_validators.helper');
...
router.put('/:id', [
    ...
    check('id').custom( validateSummaryById ),
    Validator
], updateData);
